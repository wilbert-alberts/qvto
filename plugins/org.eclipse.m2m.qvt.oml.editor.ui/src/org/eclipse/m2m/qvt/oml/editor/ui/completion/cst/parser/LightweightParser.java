...
public class LightweightParser extends PrsStream implements RuleAction {
    ...
    public void ruleAction(int ruleNumber)
    {
        ...
        switch(ruleNumber)
        {
			...
			//
			// Rule 320:  mappingQueryCS ::= query mappingDeclarationCS ;
			//
			case 320: {
			...
			//
			// Rule 321:  mappingQueryCS ::= query mappingDeclarationCS qvtErrorToken
			//
			case 321: {
			...
			//
			// Rule 322:  mappingQueryCS ::= query qvtErrorToken
			//
			case 322: {
			...
			//
			// Rule 323:  entryDeclarationCS ::= main ( parameterListOpt )
			//
			case 323: {
