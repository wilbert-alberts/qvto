...
* </copyright>
*
* $Id: LightweightParser.java,v 1.7 2008/01/10 17:04:29 radvorak Exp $
*/
/**
* <copyright>
*
...
import org.eclipse.m2m.qvt.oml.internal.cst.parser.AbstractQVTParser;	
    ...
    public void ruleAction(int ruleNumber)
    {
        ...
        switch(ruleNumber)
        {
			...
			//
			// Rule 439:  legacyWhileExpCS ::= while ( oclExpressionCS ; oclExpressionCS ) { statementListOpt }
			//
			case 439: {
			...
			//
			// Rule 441:  whileExpCS ::= while ( declaratorCS ; oclExpressionCS ) { statementListOpt }
			//
			case 441: {
			...
			//
			// Rule 442:  whileExpCS ::= while ( oclExpressionCS ) { statementListOpt }
			//
			case 442: {
			...
			//
			// Rule 477:  ifExpBodyCS ::= { statementListOpt }
			//
			case 477: {
			...
			//
			// Rule 535:  mappingRuleCS ::= entryDeclarationCS ;
			//
			case 535: {
