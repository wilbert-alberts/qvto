...
* </copyright>
*
* $Id: QvtOpLPGParser.java,v 1.55 2009/02/03 21:32:02 sboyko Exp $
*/
/**
* <copyright>
*
...
import org.eclipse.ocl.cst.LiteralExpCS;	
	...
	public void ruleAction(int ruleNumber)
	{
		switch (ruleNumber) {
			...
			//
			// Rule 328:  listTypeCS ::= List ( typeCS )
			//
			case 328: {
			...
			//
			// Rule 330:  dictTypeCS ::= Dict ( typeCS , typeCS )
			//
			case 330: {
			...
			//
			// Rule 331:  dictLiteralCS ::= Dict { dictLiteralPartListCSopt }
			//
			case 331: {
			...
			//
			// Rule 335:  dictLiteralPartCS ::= literalSimpleCS = oclExpressionCS
			//
			case 335: {
			...
			//
			// Rule 337:  dictLiteralPartListCSopt ::= $Empty
			//
			case 337:
				dtParser.setSym1(new BasicEList());
				break;
			...
			//
			// Rule 338:  dictLiteralPartListCS ::= dictLiteralPartCS
			//
			case 338: {
			...
			//
			// Rule 339:  dictLiteralPartListCS ::= dictLiteralPartListCS , dictLiteralPartCS
			//
			case 339: {
			...
			//
			// Rule 341:  returnExpCS ::= return oclExpressionCSOpt
			//
			case 341: {
			...
			//
			// Rule 343:  var_init_group_exp ::= var var_init_declarator_list
			//
			case 343: {
			...
			//
			// Rule 345:  var_init_group_exp ::= var ( var_init_declarator_list qvtErrorToken
			//
			case 345: {
			...
			//
			// Rule 347:  var_init_exp ::= var var_init_declarator
			//
			case 347: {
			...
			//
			// Rule 349:  var_init_exp ::= var ( var_init_declarator qvtErrorToken
			//
			case 349: {
			...
			//
			// Rule 350:  var_init_exp ::= var qvtErrorToken
			//
			case 350: {
			...
			//
			// Rule 351:  var_init_declarator_list ::= var_init_declarator , var_init_declarator
			//
			case 351: {
			...
			//
			// Rule 352:  var_init_declarator_list ::= var_init_declarator_list , var_init_declarator
			//
			case 352: {
			...
			//
			// Rule 353:  var_init_declarator ::= IDENTIFIER : typeCS var_init_op oclExpressionCS
			//
			case 353: {
			...
			//
			// Rule 354:  var_init_declarator ::= IDENTIFIER : typeCS var_init_op qvtErrorToken
			//
			case 354: {
			...
			//
			// Rule 355:  var_init_declarator ::= IDENTIFIER var_init_op oclExpressionCS
			//
			case 355: {
			...
			//
			// Rule 356:  var_init_declarator ::= IDENTIFIER var_init_op qvtErrorToken
			//
			case 356: {
			...
			//
			// Rule 357:  var_init_declarator ::= IDENTIFIER : typeCS
			//
			case 357: {
			...
			//
			// Rule 358:  var_init_declarator ::= IDENTIFIER : qvtErrorToken
			//
			case 358: {
			...
			//
			// Rule 363:  assignStatementCS ::= dotArrowExpCS := oclExpressionCS
			//
			case 363: {
			...
			//
			// Rule 364:  assignStatementCS ::= dotArrowExpCS := qvtErrorToken
			//
			case 364: {
			...
			//
			// Rule 365:  assignStatementCS ::= dotArrowExpCS += oclExpressionCS
			//
			case 365: {
			...
			//
			// Rule 366:  assignStatementCS ::= dotArrowExpCS += qvtErrorToken
			//
			case 366: {
			...
			//
			// Rule 368:  whileExpCS ::= while ( declarator1 ; oclExpressionCS ) whileBodyCS
			//
			case 368: {
			...
			//
			// Rule 369:  whileExpCS ::= while ( assignStatementCS ; oclExpressionCS ) whileBodyCS
			//
			case 369: {
			...
			//
			// Rule 370:  whileExpCS ::= while ( oclExpressionCS ) whileBodyCS
			//
			case 370: {
			...
			//
			// Rule 374:  forExpDeclaratorList ::= IDENTIFIER
			//
			case 374: {
		...
		dtParser.setSym1(result);
			...
			//
			// Rule 375:  forExpDeclaratorList ::= forExpDeclaratorList , IDENTIFIER
			//
			case 375: {
		...
		dtParser.setSym1(result);
			...
			//
			// Rule 376:  forExpConditionOpt ::= $Empty
			//
			case 376:
				dtParser.setSym1(null);
				break;
			...
			//
			// Rule 377:  forExpConditionOpt ::= | oclExpressionCS
			//
			case 377: {
			...
			//
			// Rule 378:  forExpConditionOpt ::= | qvtErrorToken
			//
			case 378:
				dtParser.setSym1(null);
				break;
			...
			//
			// Rule 379:  forExpCS ::= forOpCode ( forExpDeclaratorList forExpConditionOpt ) expression_block
			//
			case 379: {
			...
			//
			// Rule 380:  forExpCS ::= forOpCode qvtErrorToken
			//
			case 380: {
			...
			//
			// Rule 395:  switchAltExpCS ::= ( oclExpressionCS ) ? oclExpressionCS ;
			//
			case 395: {
			...
			//
			// Rule 396:  switchAltExpCS ::= case ( oclExpressionCS ) expression_statement
			//
			case 396: {
			...
			//
			// Rule 397:  switchAltExpCS ::= ( oclExpressionCS ) ? oclExpressionCS qvtErrorToken
			//
			case 397: {
			...
			//
			// Rule 398:  switchAltExpCS ::= ( oclExpressionCS ) qvtErrorToken
			//
			case 398: {
			...
			//
			// Rule 399:  switchAltExpCS ::= ( qvtErrorToken
			//
			case 399: {
			...
			//
			// Rule 400:  switchElseExpCSOpt ::= $Empty
			//
			case 400:
				dtParser.setSym1(null);
				break;
			...
			//
			// Rule 402:  switchElseExpCS ::= else ? oclExpressionCS ;
			//
			case 402: {
			...
			//
			// Rule 403:  switchElseExpCS ::= else expression_statement
			//
			case 403: {
			...
			//
			// Rule 404:  switchElseExpCS ::= else ? oclExpressionCS qvtErrorToken
			//
			case 404: {
		...
		dtParser.setSym1(result);
			...
			//
			// Rule 446:  topLevel ::= unit_elementList
			//
			case 446: {
			...
			//
			// Rule 449:  _import ::= import qvtErrorToken
			//
			case 449: {
			...
			//
			// Rule 451:  unit_elementList ::= unit_elementList unit_element
			//
			case 451: {
			...
			//
			// Rule 452:  unit_elementList ::= $Empty
			//
			case 452:
				dtParser.setSym1(new BasicEList());
				break;
			...
			//
			// Rule 508:  _modeltype ::= modeltype IDENTIFIER compliance_kindOpt uses packageref_list modeltype_whereOpt ;
			//
			case 508: {
			...
			//
			// Rule 509:  _modeltype ::= modeltype qvtErrorToken
			//
			case 509: {
			...
			//
			// Rule 510:  modeltype_whereOpt ::= $Empty
			//
			case 510:
				dtParser.setSym1(new BasicEList());
				break;
			...
			//
			// Rule 512:  modeltype_where ::= where expression_block
			//
			case 512: {
			...
			//
			// Rule 513:  packageref_list ::= packageref
			//
			case 513: {
			...
			//
			// Rule 514:  packageref_list ::= packageref_list , packageref
			//
			case 514: {
			...
			//
			// Rule 515:  packageref ::= pathNameCS
			//
			case 515: {
			...
			//
			// Rule 516:  packageref ::= pathNameCS ( uri )
			//
			case 516: {
			...
			//
			// Rule 523:  classifierExtensionOpt ::= $Empty
			//
			case 523:
				dtParser.setSym1(new BasicEList());
				break;
			...
			//
			// Rule 524:  classifierExtensionOpt ::= extends type_list
			//
			case 524: {
			...
			//
			// Rule 526:  type_list ::= type_list , typeCS
			//
			case 526: {
			...
			//
			// Rule 527:  type_list ::= type_list qvtErrorToken
			//
			case 527: {
			...
			//
			// Rule 528:  classifierFeatureListOpt ::= $Empty
			//
			case 528:
				dtParser.setSym1(new BasicEList());
				break;
			...
			//
			// Rule 530:  classifierFeatureList ::= classifierFeatureCS
			//
			case 530: {
			...
			//
			// Rule 531:  classifierFeatureList ::= classifierFeatureList ; classifierFeatureCS
			//
			case 531: {
			...
			//
			// Rule 532:  classifierFeatureList ::= classifierFeatureList qvtErrorToken
			//
			case 532: {
			...
			//
			// Rule 533:  classifierFeatureCS ::= stereotype_qualifier_list feature_key_list qvtIdentifierCS : typeCS multiplicityOpt ordered_prop opposite_propertyOpt init_partOpt
			//
			case 533: {
			...
			//
			// Rule 585:  constructor_header_pure ::= constructor scoped_identifier simple_signature
			//
			case 585: {
				
				SimpleSignatureCS signature = (SimpleSignatureCS) dtParser.getSym(3);					
				MappingDeclarationCS mappingDeclarationCS = createMappingDeclarationCS(
					null,
					(ScopedNameCS) dtParser.getSym(2),
					signature.getParams(),
				...
				setOffsets(mappingDeclarationCS, getIToken(dtParser.getToken(1)), signature);
			...
			//
			// Rule 586:  constructor_header ::= qualifierList constructor_header_pure
			//
			case 586: {
				
				MappingDeclarationCS mappingDeclarationCS = (MappingDeclarationCS) dtParser.getSym(2);
			...
			//
			// Rule 589:  constructor_def_pure ::= constructor_header_pure expression_block
			//
			case 589:
 
			//
			// Rule 590:  constructor_def ::= constructor_header expression_block semicolonOpt
			//
			case 590: {
			...
			//
			// Rule 593:  entry_header ::= main simple_signature
			//
			case 593: {
			...
			//
			// Rule 594:  entry_header ::= main qvtErrorToken
			//
			case 594: {
			...
			//
			// Rule 595:  entry_decl ::= entry_header ;
			//
			case 595: {
			...
			//
			// Rule 596:  entry_def ::= entry_header expression_block semicolonOpt
			//
			case 596: {
			...
			//
			// Rule 597:  _tag ::= tag stringLiteralExpCS scoped_identifier tag_valueOpt
			//
			case 597: {
			...
			//
			// Rule 599:  tag_valueOpt ::= = oclExpressionCS
			//
			case 599: {
			...
			//
			// Rule 602:  mapping_decl ::= mapping_full_header ;
			//
			case 602: {
			...
			//
			// Rule 603:  mapping_def ::= mapping_full_header { mapping_body } semicolonOpt
			//
			case 603: {
			...
			//
			// Rule 604:  mapping_def ::= mapping_full_header { qvtErrorToken
			//
			case 604: {
			...
			//
			// Rule 605:  mapping_full_header ::= mapping_header _whenOpt
			//
			case 605: {
			...
			//
			// Rule 606:  mapping_header ::= qualifierList mapping param_directionOpt scoped_identifier complete_signature mapping_extraList
			//
			case 606: {
			...
			//
			// Rule 607:  mapping_header ::= qualifierList mapping param_directionOpt scoped_identifier qvtErrorToken
			//
			case 607: {
			...
			//
			// Rule 608:  mapping_header ::= qualifierList mapping qvtErrorToken
			//
			case 608: {
			...
			//
			// Rule 609:  mapping_extraList ::= mapping_extraList mapping_extra
			//
			case 609: {
			...
			//
			// Rule 610:  mapping_extraList ::= $Empty
			//
			case 610:
				dtParser.setSym1(new BasicEList());
				break;
			...
			//
			// Rule 612:  mapping_extension ::= mapping_extension_key scoped_identifier_list
			//
			case 612: {
			...
			//
			// Rule 618:  _when ::= when { oclExpressionCS semicolonOpt }
			//
			case 618: {
			...
			//
			// Rule 619:  _when ::= when qvtErrorToken
			//
			case 619:
				dtParser.setSym1(null);
				break;
			...
			//
			// Rule 620:  mapping_body ::= init_sectionOpt population_sectionOpt end_sectionOpt
			//
			case 620: {
			...
			//
			// Rule 621:  init_sectionOpt ::= $Empty
			//
			case 621:
				dtParser.setSym1(null);
				break;
			...
			//
			// Rule 623:  init_section ::= init expression_block
			//
			case 623: {
			...
			//
			// Rule 624:  init_section ::= init qvtErrorToken
			//
			case 624: {
			...
			//
			// Rule 625:  population_sectionOpt ::= $Empty
			//
			case 625: {
			...
			//
			// Rule 627:  population_section ::= expression_list
			//
			case 627: {
			...
			//
			// Rule 628:  population_section ::= population expression_block
			//
			case 628: {
			...
			//
			// Rule 629:  population_section ::= population qvtErrorToken
			//
			case 629: {
			...
			//
			// Rule 632:  end_section ::= end expression_block
			//
			case 632: {
			...
			//
			// Rule 633:  end_section ::= end qvtErrorToken
			//
			case 633: {
			...
			//
			// Rule 636:  objectDeclCS ::= typespec
			//
			case 636: {
			...
			//
			// Rule 640:  objectDeclCS ::= objectIdentifierCS : typespecOpt
			//
			case 640: {
			...
			//
			// Rule 641:  outExpCS ::= object objectDeclCS expression_block
			//
			case 641: {
			...
			//
			// Rule 642:  outExpCS ::= object objectDeclCS qvtErrorToken
			//
			case 642: {
			...
			//
			// Rule 643:  featureMappingCallExpCS ::= map simpleNameCS ( argumentsCSopt )
			//
			case 643: {
			...
			//
			// Rule 644:  featureMappingCallExpCS ::= xmap simpleNameCS ( argumentsCSopt )
			//
			case 644: {
			...
			//
			// Rule 645:  mappingCallExpCS ::= map pathNameCS ( argumentsCSopt )
			//
			case 645: {
			...
			//
			// Rule 646:  mappingCallExpCS ::= xmap pathNameCS ( argumentsCSopt )
			//
			case 646: {
			...
			//
			// Rule 647:  resolveConditionOpt ::= $Empty
			//
			case 647:
				dtParser.setSym1(null);
				break;
			...
			//
			// Rule 648:  resolveConditionOpt ::= | oclExpressionCS
			//
			case 648: {
			...
			//
			// Rule 649:  resolveConditionOpt ::= | qvtErrorToken
			//
			case 649:
				dtParser.setSym1(null);
				break;
			...
			//
			// Rule 651:  IDENTIFIEROpt ::= IDENTIFIER :
			//
			case 651: {
			...
			//
			// Rule 652:  resolveOpArgsExpCSOpt ::= $Empty
			//
			case 652:
				dtParser.setSym1(null);
				break;
			...
			//
			// Rule 654:  resolveOpArgsExpCS ::= IDENTIFIEROpt typeCS resolveConditionOpt
			//
			case 654: {
			...
			//
			// Rule 661:  resolveExpCS ::= lateOpt resolveOp ( resolveOpArgsExpCSOpt )
			//
			case 661: {
			...
			//
			// Rule 662:  resolveExpCS ::= lateOpt resolveOp ( resolveOpArgsExpCSOpt qvtErrorToken
			//
			case 662: {
			...
			//
			// Rule 663:  resolveExpCS ::= lateOpt resolveOp qvtErrorToken
			//
			case 663: {
			...
			//
			// Rule 664:  resolveExpCS ::= late qvtErrorToken
			//
			case 664: {
			...
			//
			// Rule 669:  resolveInExpCS ::= lateOpt resolveInOp ( scoped_identifier , resolveOpArgsExpCS )
			//
			case 669: {
			...
			//
			// Rule 670:  resolveInExpCS ::= lateOpt resolveInOp ( scoped_identifier )
			//
			case 670: {
			...
			//
			// Rule 671:  resolveInExpCS ::= lateOpt resolveInOp ( scoped_identifier , resolveOpArgsExpCSOpt qvtErrorToken
			//
			case 671: {
			...
			//
			// Rule 672:  resolveInExpCS ::= lateOpt resolveInOp ( scoped_identifier qvtErrorToken
			//
			case 672: {
			...
			//
			// Rule 677:  callExpCS ::= . resolveResolveInExpCS
			//
			case 677: {
			...
			//
			// Rule 682:  simpleNameCS ::= this
			//
			case 682:
 
			//
			// Rule 683:  simpleNameCS ::= result
			//
			case 683: {
