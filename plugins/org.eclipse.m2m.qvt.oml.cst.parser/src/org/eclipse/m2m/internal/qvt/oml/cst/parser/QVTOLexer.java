...
* </copyright>
*
* $Id: QVTOLexer.java,v 1.2 2010/01/06 18:55:02 sboyko Exp $
*/
/**
* <copyright>
*
...
public class QVTOLexer extends AbstractLexer implements QVTOParsersym, QVTOLexersym, RuleAction
{
	...
	public QVTOLexer(Environment<?,?,?,?,?,?,?,?,?,?,?,?> environment, char[] chars) {
		...
		kwLexer = new QVTOKWLexer(getInputChars(), QVTOParsersym.TK_IDENTIFIER);
	}
    ...
    public void lexToTokens(Monitor monitor, AbstractParser parser)
    {
        ...
        parser.makeToken(i, i, QVTOParsersym.TK_EOF_TOKEN); // and end with the end of file token
