...
* </copyright>
*
* $Id: LightweightTypeParser.java,v 1.6 2010/01/24 13:58:42 sboyko Exp $
*/
/**
* <copyright>
*
...
protected String getTokenText(int i) {
    ...
    public void ruleAction(int ruleNumber)
    {
		...
		if (source instanceof ImperativeIterateExpCS) {
			String opCode = isTokenOfType(getIToken( /* macro getToken is deprecated. Use function getRhsTokenIndex */ getParser().getToken(2)), LightweightTypeParsersym.TK_EXCLAMATION_MARK) 
