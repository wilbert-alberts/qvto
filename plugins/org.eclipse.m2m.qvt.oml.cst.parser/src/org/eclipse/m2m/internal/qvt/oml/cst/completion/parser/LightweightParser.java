...
* </copyright>
*
* $Id: LightweightParser.java,v 1.4 2010/01/09 18:33:29 sboyko Exp $
*/
/**
* <copyright>
*
...
import org.eclipse.m2m.internal.qvt.oml.cst.parser.AbstractQVTParser;	
    ...
    public void ruleAction(int ruleNumber)
    {
		...
		if (source instanceof ImperativeIterateExpCS) {
			String opCode = isTokenOfType(getIToken(dtParser.getToken(2)), LightweightParsersym.TK_EXCLAMATION_MARK) 
