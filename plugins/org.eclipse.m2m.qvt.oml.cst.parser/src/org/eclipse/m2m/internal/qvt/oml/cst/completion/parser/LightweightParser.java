...
* </copyright>
*
* $Id: LightweightParser.java,v 1.6 2010/01/24 13:58:43 sboyko Exp $
*/
/**
* <copyright>
*
...
protected String getTokenText(int i) {
    ...
    public void ruleAction(int ruleNumber)
    {
		...
		if (source instanceof ImperativeIterateExpCS) {
			String opCode = isTokenOfType(getIToken( /* macro getToken is deprecated. Use function getRhsTokenIndex */ getParser().getToken(2)), LightweightParsersym.TK_EXCLAMATION_MARK) 
