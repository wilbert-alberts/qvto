 ...
 *******************************************************************************/
package org.eclipse.m2m.internal.qvt.oml.common.ui.util;
...
import org.eclipse.m2m.internal.qvt.oml.common.ui.QvtCommonUIPlugin;
...
public class ConvertProjectUtil {
    ...
    private static void updateBuildPath(IProject project) throws CoreException {
        ...
        try {
            ...
            throw new CoreException(new Status(IStatus.ERROR, QvtCommonUIPlugin.PLUGIN_ID, 1, e.getMessage(), e));
        }
