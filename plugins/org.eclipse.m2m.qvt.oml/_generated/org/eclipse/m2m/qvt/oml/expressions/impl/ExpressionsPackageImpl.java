...
public class ExpressionsPackageImpl extends EPackageImpl implements ExpressionsPackage {
	 ...
	 * @see org.eclipse.m2m.qvt.oml.expressions.ExpressionsPackage#eNS_URI
	 * @see #init()
	 * @generated NOT
	 */
	 ...
	 * @generated
	 */
	public EReference getProperty_Module() {
	 ...
	 * @generated
	 */
	public EReference getObjectExp_Content() {
	...
	public void createPackageContents() {
		...
		createEReference(moduleEClass, MODULE__MODEL_PARAMETER);
		...
		createEReference(propertyEClass, PROPERTY__MODULE);
	...
	public void initializePackageContents() {
		...
		propertyEClass.getESuperTypes().add(theEcorePackage.getEParameter());
		...
		varParameterEClass.getESuperTypes().add(this.getVisitableASTNode());
		...
		EGenericType g2 = createEGenericType(theEcorePackage.getEClassifier());
		...
		initEReference(getModule_ConfigProperty(), this.getProperty(), this.getProperty_Module(), "configProperty", null, 0, -1, Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getModule_Entry(), theEcorePackage.getEOperation(), null, "entry", null, 0, 1, Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(getModule_ModelParameter(), this.getModelParameter(), null, "modelParameter", null, 0, -1, Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getLibrary_Library(), theEcorePackage.getEObject(), null, "library", null, 0, 1, Library.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getProperty_Module(), this.getModule(), this.getModule_ConfigProperty(), "module", null, 0, 1, Property.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEAttribute(getAssignExp_IsReset(), theEcorePackage.getEBoolean(), "isReset", null, 0, 1, AssignExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		g2 = createEGenericType(theEcorePackage.getEClassifier());
		g1.getETypeArguments().add(g2);
		initEReference(getObjectExp_Content(), g1, null, "content", null, 0, -1, ObjectExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(getObjectExp_ReferredObject(), this.getModelParameter(), null, "referredObject", null, 1, 1, ObjectExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEAttribute(getPackageRef_Uri(), theEcorePackage.getEString(), "uri", null, 0, 1, PackageRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(getPackageRef_Name(), theEcorePackage.getEString(), "name", null, 0, 1, PackageRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEAttribute(getAssertExp_Line(), theEcorePackage.getEInt(), "line", "-1", 0, 1, AssertExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
