 ...
 *   <li>{@link org.eclipse.m2m.qvt.oml.expressions.impl.OperationBodyImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationBodyImpl extends EObjectImpl implements OperationBody {
	 ...
	 * @ordered
	 */
	protected EList<Variable<EClassifier, EParameter>> variable;
	 ...
	 * @generated
	 */
	public EList<Variable<EClassifier, EParameter>> getVariable() {
		if (variable == null) {
			variable = new EObjectContainmentEList<Variable<EClassifier, EParameter>>(Variable.class, this, ExpressionsPackage.OPERATION_BODY__VARIABLE);
		}
		return variable;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ExpressionsPackage.OPERATION_BODY__VARIABLE:
				getVariable().clear();
				getVariable().addAll((Collection<? extends Variable<EClassifier, EParameter>>)newValue);
				return;
		}
