 ...
 * </copyright>
 *
 * $Id: BlockExpItemProvider.java,v 1.3 2009/12/09 14:02:53 radvorak Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.m2m.qvt.oml.ecore.ImperativeOCL.BlockExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlockExpItemProvider
	 ...
	 * @generated
	 */
	public BlockExpItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ImperativeOCLPackage.Literals.BLOCK_EXP__BODY);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BlockExp")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((BlockExp)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_BlockExp_type") : //$NON-NLS-1$
			getString("_UI_BlockExp_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BlockExp.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ImperativeOCLPackage.Literals.BLOCK_EXP__BODY,
