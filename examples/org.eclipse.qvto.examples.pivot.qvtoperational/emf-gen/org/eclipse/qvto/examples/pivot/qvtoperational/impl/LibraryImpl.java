...
public class LibraryImpl extends ModuleImpl implements Library {
	...
	public <R> R accept(final Visitor<R> v) {
		return ((QVTOperationalVisitor<R>)v).visitLibrary(this);
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Module.class) {
			switch (baseOperationID) {
				...
				case QVTOperationalPackage.MODULE___ACCEPT__VISITOR: return QVTOperationalPackage.LIBRARY___ACCEPT__VISITOR;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case QVTOperationalPackage.LIBRARY___ACCEPT__VISITOR:
