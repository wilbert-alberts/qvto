...
:
(
{ before(grammarAccess.getTopLevelCSAccess().getOwnedNestedPackageMetamodelCSParserRuleCall_1_0()); }
	ruleMetamodelCS{ after(grammarAccess.getTopLevelCSAccess().getOwnedNestedPackageMetamodelCSParserRuleCall_1_0()); }
)
