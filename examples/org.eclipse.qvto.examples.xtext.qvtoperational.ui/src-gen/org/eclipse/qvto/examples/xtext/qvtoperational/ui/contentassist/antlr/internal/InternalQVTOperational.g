...
:
(
{ before(grammarAccess.getTransformationDefCSAccess().getRightCurlyBracketKeyword_2()); }

	'}' 

{ after(grammarAccess.getTransformationDefCSAccess().getRightCurlyBracketKeyword_2()); }
)
