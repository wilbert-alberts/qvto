		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMetamodelCSAccess().getAlternatives_2(), "rule__MetamodelCS__Alternatives_2");
					put(grammarAccess.getMetamodelElementCSAccess().getAlternatives(), "rule__MetamodelElementCS__Alternatives");
					put(grammarAccess.getClassifierCSAccess().getAlternatives_5(), "rule__ClassifierCS__Alternatives_5");
					put(grammarAccess.getClassifierFeatureCSAccess().getAlternatives(), "rule__ClassifierFeatureCS__Alternatives");
					put(grammarAccess.getEnumerationCSAccess().getAlternatives_2(), "rule__EnumerationCS__Alternatives_2");
					...
					put(grammarAccess.getCompleteSignatureCSAccess().getGroup(), "rule__CompleteSignatureCS__Group__0");
					put(grammarAccess.getCompleteSignatureCSAccess().getGroup_1(), "rule__CompleteSignatureCS__Group_1__0");
					put(grammarAccess.getCompleteSignatureCSAccess().getGroup_1_1(), "rule__CompleteSignatureCS__Group_1_1__0");
					put(grammarAccess.getCompleteSignatureCSAccess().getGroup_1_1_1(), "rule__CompleteSignatureCS__Group_1_1_1__0");
					...
					put(grammarAccess.getParamCSAccess().getGroup(), "rule__ParamCS__Group__0");
					put(grammarAccess.getParamCSAccess().getGroup_1(), "rule__ParamCS__Group_1__0");
					...
					put(grammarAccess.getMetamodelCSAccess().getGroup_2_1(), "rule__MetamodelCS__Group_2_1__0");
					put(grammarAccess.getClassifierCSAccess().getGroup(), "rule__ClassifierCS__Group__0");
					put(grammarAccess.getClassifierCSAccess().getGroup_4(), "rule__ClassifierCS__Group_4__0");
					put(grammarAccess.getClassifierCSAccess().getGroup_4_1(), "rule__ClassifierCS__Group_4_1__0");
					put(grammarAccess.getClassifierCSAccess().getGroup_4_1_1(), "rule__ClassifierCS__Group_4_1_1__0");
					put(grammarAccess.getClassifierCSAccess().getGroup_5_1(), "rule__ClassifierCS__Group_5_1__0");
					put(grammarAccess.getClassifierCSAccess().getGroup_5_1_1(), "rule__ClassifierCS__Group_5_1_1__0");
					put(grammarAccess.getClassifierCSAccess().getGroup_5_1_1_1(), "rule__ClassifierCS__Group_5_1_1_1__0");
					put(grammarAccess.getClassifierPropertyCSAccess().getGroup(), "rule__ClassifierPropertyCS__Group__0");
					put(grammarAccess.getClassifierPropertyCSAccess().getGroup_0(), "rule__ClassifierPropertyCS__Group_0__0");
					put(grammarAccess.getClassifierPropertyCSAccess().getGroup_0_1(), "rule__ClassifierPropertyCS__Group_0_1__0");
					put(grammarAccess.getClassifierPropertyCSAccess().getGroup_0_1_1(), "rule__ClassifierPropertyCS__Group_0_1_1__0");
					put(grammarAccess.getClassifierPropertyCSAccess().getGroup_7(), "rule__ClassifierPropertyCS__Group_7__0");
					...
					put(grammarAccess.getClassifierOperationCSAccess().getGroup_0(), "rule__ClassifierOperationCS__Group_0__0");
					put(grammarAccess.getClassifierOperationCSAccess().getGroup_0_1(), "rule__ClassifierOperationCS__Group_0_1__0");
					put(grammarAccess.getClassifierOperationCSAccess().getGroup_0_1_1(), "rule__ClassifierOperationCS__Group_0_1_1__0");
					...
					put(grammarAccess.getEnumerationCSAccess().getGroup_2_1_1_1(), "rule__EnumerationCS__Group_2_1_1_1__0");
					...
					put(grammarAccess.getTypedefCSAccess().getGroup(), "rule__TypedefCS__Group__0");
					put(grammarAccess.getTypedefCSAccess().getGroup_4(), "rule__TypedefCS__Group_4__0");
					...
					put(grammarAccess.getCompleteSignatureCSAccess().getParamAssignment_1_1_0(), "rule__CompleteSignatureCS__ParamAssignment_1_1_0");
					put(grammarAccess.getCompleteSignatureCSAccess().getParamAssignment_1_1_1_1(), "rule__CompleteSignatureCS__ParamAssignment_1_1_1_1");
					put(grammarAccess.getSimpleSignatureCSAccess().getParamAssignment_2_0(), "rule__SimpleSignatureCS__ParamAssignment_2_0");
					put(grammarAccess.getSimpleSignatureCSAccess().getParamAssignment_2_1_1(), "rule__SimpleSignatureCS__ParamAssignment_2_1_1");
					put(grammarAccess.getParamCSAccess().getDirectionAssignment_0(), "rule__ParamCS__DirectionAssignment_0");
					put(grammarAccess.getParamCSAccess().getPathNameAssignment_1_0(), "rule__ParamCS__PathNameAssignment_1_0");
					put(grammarAccess.getParamCSAccess().getTypespecAssignment_2(), "rule__ParamCS__TypespecAssignment_2");
					put(grammarAccess.getParamCSAccess().getInitPartAssignment_3(), "rule__ParamCS__InitPartAssignment_3");
					...
					put(grammarAccess.getMetamodelCSAccess().getKeywordAssignment_0(), "rule__MetamodelCS__KeywordAssignment_0");
					put(grammarAccess.getMetamodelCSAccess().getPathNameAssignment_1(), "rule__MetamodelCS__PathNameAssignment_1");
					put(grammarAccess.getMetamodelCSAccess().getElementAssignment_2_1_1(), "rule__MetamodelCS__ElementAssignment_2_1_1");
					put(grammarAccess.getClassifierCSAccess().getIntermediateAssignment_0(), "rule__ClassifierCS__IntermediateAssignment_0");
					put(grammarAccess.getClassifierCSAccess().getQualifierAssignment_1(), "rule__ClassifierCS__QualifierAssignment_1");
					put(grammarAccess.getClassifierCSAccess().getKeywordAssignment_2(), "rule__ClassifierCS__KeywordAssignment_2");
					put(grammarAccess.getClassifierCSAccess().getPathNameAssignment_3(), "rule__ClassifierCS__PathNameAssignment_3");
					put(grammarAccess.getClassifierCSAccess().getExtendsAssignment_4_1_0(), "rule__ClassifierCS__ExtendsAssignment_4_1_0");
					put(grammarAccess.getClassifierCSAccess().getExtendsAssignment_4_1_1_1(), "rule__ClassifierCS__ExtendsAssignment_4_1_1_1");
					put(grammarAccess.getClassifierCSAccess().getFeatureAssignment_5_1_1_0(), "rule__ClassifierCS__FeatureAssignment_5_1_1_0");
					put(grammarAccess.getClassifierCSAccess().getFeatureAssignment_5_1_1_1_1(), "rule__ClassifierCS__FeatureAssignment_5_1_1_1_1");
					put(grammarAccess.getClassifierPropertyCSAccess().getStereotypeAssignment_0_1_0(), "rule__ClassifierPropertyCS__StereotypeAssignment_0_1_0");
					put(grammarAccess.getClassifierPropertyCSAccess().getStereotypeAssignment_0_1_1_1(), "rule__ClassifierPropertyCS__StereotypeAssignment_0_1_1_1");
					put(grammarAccess.getClassifierPropertyCSAccess().getFeatureKeyAssignment_1(), "rule__ClassifierPropertyCS__FeatureKeyAssignment_1");
					put(grammarAccess.getClassifierPropertyCSAccess().getNameAssignment_2(), "rule__ClassifierPropertyCS__NameAssignment_2");
					put(grammarAccess.getClassifierPropertyCSAccess().getTypespecAssignment_4(), "rule__ClassifierPropertyCS__TypespecAssignment_4");
					put(grammarAccess.getClassifierPropertyCSAccess().getInitPartAssignment_5(), "rule__ClassifierPropertyCS__InitPartAssignment_5");
					put(grammarAccess.getClassifierPropertyCSAccess().getMultiplicityAssignment_6(), "rule__ClassifierPropertyCS__MultiplicityAssignment_6");
					put(grammarAccess.getClassifierPropertyCSAccess().getTildeAssignment_7_1(), "rule__ClassifierPropertyCS__TildeAssignment_7_1");
					put(grammarAccess.getClassifierPropertyCSAccess().getOppositeIdentifierAssignment_7_2(), "rule__ClassifierPropertyCS__OppositeIdentifierAssignment_7_2");
					put(grammarAccess.getClassifierPropertyCSAccess().getOppositeMultiplicityAssignment_7_3(), "rule__ClassifierPropertyCS__OppositeMultiplicityAssignment_7_3");
					put(grammarAccess.getMultiplicityCSAccess().getLowerAssignment_1_0(), "rule__MultiplicityCS__LowerAssignment_1_0");
					put(grammarAccess.getMultiplicityCSAccess().getUpperAssignment_2(), "rule__MultiplicityCS__UpperAssignment_2");
					put(grammarAccess.getClassifierOperationCSAccess().getStereotypeAssignment_0_1_0(), "rule__ClassifierOperationCS__StereotypeAssignment_0_1_0");
					put(grammarAccess.getClassifierOperationCSAccess().getStereotypeAssignment_0_1_1_1(), "rule__ClassifierOperationCS__StereotypeAssignment_0_1_1_1");
					put(grammarAccess.getClassifierOperationCSAccess().getFeatureKeyAssignment_1(), "rule__ClassifierOperationCS__FeatureKeyAssignment_1");
					put(grammarAccess.getClassifierOperationCSAccess().getNameAssignment_2(), "rule__ClassifierOperationCS__NameAssignment_2");
					put(grammarAccess.getClassifierOperationCSAccess().getTypespecAssignment_4(), "rule__ClassifierOperationCS__TypespecAssignment_4");
					put(grammarAccess.getClassifierOperationCSAccess().getSignatureAssignment_5(), "rule__ClassifierOperationCS__SignatureAssignment_5");
					put(grammarAccess.getEnumerationCSAccess().getNameAssignment_1(), "rule__EnumerationCS__NameAssignment_1");
					put(grammarAccess.getEnumerationCSAccess().getLiteralAssignment_2_1_1_0(), "rule__EnumerationCS__LiteralAssignment_2_1_1_0");
					put(grammarAccess.getEnumerationCSAccess().getLiteralAssignment_2_1_1_1_1(), "rule__EnumerationCS__LiteralAssignment_2_1_1_1_1");
					put(grammarAccess.getTagCSAccess().getIdAssignment_1(), "rule__TagCS__IdAssignment_1");
					...
					put(grammarAccess.getTypedefCSAccess().getNameAssignment_1(), "rule__TypedefCS__NameAssignment_1");
					put(grammarAccess.getTypedefCSAccess().getTypespecAssignment_3(), "rule__TypedefCS__TypespecAssignment_3");
					put(grammarAccess.getTypedefCSAccess().getConditionAssignment_4_1(), "rule__TypedefCS__ConditionAssignment_4_1");
