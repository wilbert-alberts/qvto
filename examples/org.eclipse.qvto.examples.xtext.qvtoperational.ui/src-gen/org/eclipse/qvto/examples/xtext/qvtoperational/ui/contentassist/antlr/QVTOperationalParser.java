		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getParameterCSAccess().getDirectionAssignment_0(), "rule__ParameterCS__DirectionAssignment_0");
					put(grammarAccess.getParameterCSAccess().getNameAssignment_1(), "rule__ParameterCS__NameAssignment_1");
					put(grammarAccess.getParameterCSAccess().getOwnedTypeAssignment_2_1(), "rule__ParameterCS__OwnedTypeAssignment_2_1");
					put(grammarAccess.getParameterCSAccess().getInitPartAssignment_3(), "rule__ParameterCS__InitPartAssignment_3");
