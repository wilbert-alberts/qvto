...
public class ContainmentVisitsGenerator extends AbstractExtendingVisitor<String, IContainmentVisitsGeneratorCtx> {
	...
	def private String createMonovaluedPropertyStub(Property astProperty, OCLExpression initExp,
		...
		result.append('''
			...
			org.eclipse.ocl.examples.domain.elements.DomainType newCS«propertyName»Type = newCS«propertyName»Evaluator.getIdResolver().getStaticTypeOf(csElement);
	...
	def private String createMultivaluedPropertyStub(Property astProperty, OCLExpression initExp,
		...
		result.append('''
			...
			org.eclipse.ocl.examples.domain.elements.DomainType newCS«propertyName»sType = newCS«propertyName»sEvaluator.getIdResolver().getStaticTypeOf(csElement);
