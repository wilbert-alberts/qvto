...
@Singleton
public class ImperativeOCLCSGrammarAccess extends AbstractGrammarElementFinder {
	...
	@Inject
	public ImperativeOCLCSGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.eclipse.qvto.examples.xtext.imperativeocl.ImperativeOCLCS".equals(grammar.getName())) {
				return grammar;
			}
