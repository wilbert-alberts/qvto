...
public class ImperativeOCLCSSyntacticSequencer extends AbstractSyntacticSequencer {

	protected ImperativeOCLCSGrammarAccess grammarAccess;
	protected AbstractElementAlias match_TupleTypeCS___LeftParenthesisKeyword_1_0_RightParenthesisKeyword_1_2__q;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (ImperativeOCLCSGrammarAccess) access;
