...
/**
 * An AbstractImperativeOCLCSPreOrderVisitor provides a default implementation for each
	...
	implements ImperativeOCLCSVisitor<Continuation<?>>
{
	 ...
	 */
	protected AbstractImperativeOCLCSPreOrderVisitor(@NonNull CS2PivotConversion context) {
		super(context);
	}
