 ...
 * @generated
 */
public class ImperativeoclcsSwitch<T>
		extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ImperativeoclcsPackage.IMPERATIVE_ITERATE_EXP_CS: {
				...
				if (result == null) result = caseInvocationExpCS(imperativeIterateExpCS);
				if (result == null) result = caseStatementCS(imperativeIterateExpCS);
				if (result == null) result = caseNamedExpCS(imperativeIterateExpCS);
			...
			case ImperativeoclcsPackage.IMPERATIVE_LOOP_EXP_CS: {
				...
				if (result == null) result = caseInvocationExpCS(imperativeLoopExpCS);
				if (result == null) result = caseStatementCS(imperativeLoopExpCS);
				if (result == null) result = caseNamedExpCS(imperativeLoopExpCS);
			...
			case ImperativeoclcsPackage.FOR_EXP_CS: {
				...
				if (result == null) result = caseInvocationExpCS(forExpCS);
				if (result == null) result = caseStatementCS(forExpCS);
				if (result == null) result = caseNamedExpCS(forExpCS);
			...
			case ImperativeoclcsPackage.LOG_EXP_CS: {
				...
				if (result == null) result = caseInvocationExpCS(logExpCS);
				if (result == null) result = caseNamedExpCS(logExpCS);
