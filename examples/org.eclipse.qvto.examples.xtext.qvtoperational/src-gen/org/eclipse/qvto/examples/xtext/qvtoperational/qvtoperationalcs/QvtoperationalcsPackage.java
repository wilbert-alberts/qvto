...
public interface QvtoperationalcsPackage extends EPackage
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  int TOP_LEVEL_CS_FEATURE_COUNT = 2;
  ...
  /**
	 * The meta object id for the '{@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.util.QVTOperationalCSVisitor <em>QVT Operational CS Visitor</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.util.QVTOperationalCSVisitor
	 * @see org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.QvtoperationalcsPackageImpl#getQVTOperationalCSVisitor()
	 * @generated
	 */
	int QVT_OPERATIONAL_CS_VISITOR = 18;

		/**
	 * The number of structural features of the '<em>QVT Operational CS Visitor</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int QVT_OPERATIONAL_CS_VISITOR_FEATURE_COUNT = EssentialOCLCSTPackage.IMPERATIVE_OCLCS_VISITOR_FEATURE_COUNT + 0;
  ...
  /**
	 * Returns the meta object for class '{@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.util.QVTOperationalCSVisitor <em>QVT Operational CS Visitor</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>QVT Operational CS Visitor</em>'.
	 * @see org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.util.QVTOperationalCSVisitor
	 * @model instanceClass="org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.util.QVTOperationalCSVisitor" typeParameters="R" superTypes="org.eclipse.ocl.examples.xtext.essentialocl.essentialOCLCST.ImperativeOCLCSVisitor<R>"
	 * @generated
	 */
	EClass getQVTOperationalCSVisitor();
  ...
  interface Literals
  {
    ...
    /**
		 * The meta object literal for the '{@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.util.QVTOperationalCSVisitor <em>QVT Operational CS Visitor</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.util.QVTOperationalCSVisitor
		 * @see org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.QvtoperationalcsPackageImpl#getQVTOperationalCSVisitor()
		 * @generated
		 */
		EClass QVT_OPERATIONAL_CS_VISITOR = eINSTANCE.getQVTOperationalCSVisitor();
