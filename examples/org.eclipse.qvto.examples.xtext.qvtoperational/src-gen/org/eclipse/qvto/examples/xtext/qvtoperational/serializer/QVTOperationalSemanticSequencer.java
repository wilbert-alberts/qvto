...
public class QVTOperationalSemanticSequencer
		extends ImperativeOCLSemanticSequencer {

	@Inject
	private QVTOperationalGrammarAccess grammarAccess;

	public void createSequence(EObject context, EObject semanticObject) {
		if (semanticObject.eClass().getEPackage() == BaseCSTPackage.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
				case BaseCSTPackage.MULTIPLICITY_BOUNDS_CS :
					if (context == grammarAccess.getMultiplicityBoundsCSRule()) {
						sequence_MultiplicityBoundsCS(context,
				...
				case BaseCSTPackage.MULTIPLICITY_STRING_CS :
					if (context == grammarAccess.getMultiplicityStringCSRule()) {
						sequence_MultiplicityStringCS(context,
				...
				case BaseCSTPackage.TUPLE_TYPE_CS :
					if (context == grammarAccess.getTupleTypeCSRule()
						|| context == grammarAccess.getTypeLiteralCSRule()) {
						sequence_TupleTypeCS(context,
							(TupleTypeCS) semanticObject);
						return;
					} else if (context == grammarAccess.getTypeExpCSRule()) {
						sequence_TupleTypeCS_TypeExpCS(context,
							(TupleTypeCS) semanticObject);
						return;
					} else if (context == grammarAccess
						.getTypeLiteralWithMultiplicityCSRule()) {
						sequence_TupleTypeCS_TypeLiteralWithMultiplicityCS(
							context, (TupleTypeCS) semanticObject);
						return;
					} else
						break;
			}
		else if (semanticObject.eClass().getEPackage() == EssentialOCLCSTPackage.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
				case EssentialOCLCSTPackage.BINARY_OPERATOR_CS :
					if (context == grammarAccess.getBinaryOperatorCSRule()
						...
						sequence_EssentialOCLInfixOperatorCS(context,
				...
				case EssentialOCLCSTPackage.BOOLEAN_LITERAL_EXP_CS :
					if (context == grammarAccess.getBooleanLiteralExpCSRule()
						...
						|| context == grammarAccess.getExpCSAccess()
							.getInfixExpCSOwnedExpressionAction_0_1_0()
				...
				case EssentialOCLCSTPackage.COLLECTION_LITERAL_EXP_CS :
					if (context == grammarAccess
						...
						|| context == grammarAccess.getPrefixedExpCSRule()
						|| context == grammarAccess.getPrimaryExpCSRule()) {
						sequence_CollectionLiteralExpCS(context,
				...
				case EssentialOCLCSTPackage.COLLECTION_LITERAL_PART_CS :
					if (context == grammarAccess
						...
						sequence_CollectionLiteralPartCS(context,
				...
				case EssentialOCLCSTPackage.COLLECTION_TYPE_CS :
					if (context == grammarAccess.getCollectionTypeCSRule()
						|| context == grammarAccess.getTypeLiteralCSRule()) {
						sequence_CollectionTypeCS(context,
							(CollectionTypeCS) semanticObject);
						return;
					} else if (context == grammarAccess.getTypeExpCSRule()) {
						sequence_CollectionTypeCS_TypeExpCS(context,
							(CollectionTypeCS) semanticObject);
						return;
					} else if (context == grammarAccess
						.getTypeLiteralWithMultiplicityCSRule()) {
						sequence_CollectionTypeCS_TypeLiteralWithMultiplicityCS(
							context, (CollectionTypeCS) semanticObject);
						return;
					} else
						break;
				...
				case EssentialOCLCSTPackage.CONSTRUCTOR_PART_CS :
					if (context == grammarAccess.getConstructorPartCSRule()) {
						sequence_ConstructorPartCS(context,
				...
				case EssentialOCLCSTPackage.INVALID_LITERAL_EXP_CS :
					if (context == grammarAccess.getExpCSRule()
						...
						|| context == grammarAccess
							.getPrimitiveLiteralExpCSRule()) {
						sequence_InvalidLiteralExpCS(context,
				...
				case EssentialOCLCSTPackage.LET_VARIABLE_CS :
					if (context == grammarAccess.getLetVariableCSRule()) {
						sequence_LetVariableCS(context,
							(LetVariableCS) semanticObject);
						return;
					} else
						break;
				case EssentialOCLCSTPackage.NAME_EXP_CS :
					if (context == grammarAccess.getPrimaryExpCSAccess()
						.getConstructorExpCSNameExpAction_10_2_1_0()
						|| context == grammarAccess.getPrimaryExpCSAccess()
							.getIndexExpCSNameExpAction_10_2_0_0()) {
						sequence_PrimaryExpCS_ConstructorExpCS_10_2_1_0_IndexExpCS_10_2_0_0(
							context, (NameExpCS) semanticObject);
						return;
						...
						|| context == grammarAccess.getPrimaryExpCSRule()
						|| context == grammarAccess.getPrimaryExpCSAccess()
							.getInvocationExpCSNameExpAction_10_2_2_1_0()) {
						sequence_PrimaryExpCS(context,
				...
				case EssentialOCLCSTPackage.NAVIGATING_ARG_CS :
					if (context == grammarAccess.getNavigatingArgCSRule()) {
						sequence_NavigatingArgCS(context,
							(NavigatingArgCS) semanticObject);
						return;
					} else if (context == grammarAccess
						.getNavigatingBarArgCSRule()) {
						sequence_NavigatingBarArgCS(context,
							(NavigatingArgCS) semanticObject);
						return;
					} else if (context == grammarAccess
						.getNavigatingCommaArgCSRule()) {
						sequence_NavigatingCommaArgCS(context,
							(NavigatingArgCS) semanticObject);
						return;
					} else if (context == grammarAccess
						.getNavigatingSemiArgCSRule()) {
						sequence_NavigatingSemiArgCS(context,
							(NavigatingArgCS) semanticObject);
						return;
					} else
						break;
				case EssentialOCLCSTPackage.NAVIGATION_OPERATOR_CS :
					if (context == grammarAccess.getBinaryOperatorCSRule()
						...
						sequence_EssentialOCLNavigationOperatorCS(context,
				...
				case EssentialOCLCSTPackage.NULL_LITERAL_EXP_CS :
					if (context == grammarAccess.getExpCSRule()
						...
						|| context == grammarAccess
							.getPrimitiveLiteralExpCSRule()) {
						sequence_NullLiteralExpCS(context,
				...
				case EssentialOCLCSTPackage.NUMBER_LITERAL_EXP_CS :
					if (context == grammarAccess.getExpCSRule()
						...
						|| context == grammarAccess
							.getPrimitiveLiteralExpCSRule()) {
						sequence_NumberLiteralExpCS(context,
				...
				case EssentialOCLCSTPackage.PREFIX_EXP_CS :
					if (context == grammarAccess.getExpCSRule()
						...
						|| context == grammarAccess.getImperativeOCLExpCSRule()
						|| context == grammarAccess.getNavigatingArgExpCSRule()) {
						sequence_ExpCS_PrefixedExpCS(context,
							(PrefixExpCS) semanticObject);
						return;
					} else if (context == grammarAccess.getExpCSAccess()
						.getInfixExpCSOwnedExpressionAction_0_1_0()
						|| context == grammarAccess.getPrefixedExpCSRule()) {
						sequence_PrefixedExpCS(context,
							(PrefixExpCS) semanticObject);
						return;
					} else
						break;
				...
				case EssentialOCLCSTPackage.STRING_LITERAL_EXP_CS :
					if (context == grammarAccess.getExpCSRule()
						...
						sequence_StringLiteralExpCS(context,
				...
				case EssentialOCLCSTPackage.TUPLE_LITERAL_EXP_CS :
					if (context == grammarAccess.getExpCSRule()
						...
						sequence_TupleLiteralExpCS(context,
				...
				case EssentialOCLCSTPackage.TUPLE_LITERAL_PART_CS :
					if (context == grammarAccess.getTupleLiteralPartCSRule()) {
						sequence_TupleLiteralPartCS(context,
				...
				case EssentialOCLCSTPackage.TYPE_LITERAL_EXP_CS :
					if (context == grammarAccess.getExpCSRule()
						...
						sequence_TypeLiteralExpCS(context,
				...
				case EssentialOCLCSTPackage.UNARY_OPERATOR_CS :
					if (context == grammarAccess
						...
						sequence_EssentialOCLUnaryOperatorCS(context,
				...
				case EssentialOCLCSTPackage.UNLIMITED_NATURAL_LITERAL_EXP_CS :
					if (context == grammarAccess.getExpCSRule()
						...
						sequence_UnlimitedNaturalLiteralExpCS(context,
							(UnlimitedNaturalLiteralExpCS) semanticObject);
						return;
					} else
						break;
			}
		else if (semanticObject.eClass().getEPackage() == ImperativeoclcsPackage.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
				case ImperativeoclcsPackage.DICT_LITERAL_EXP_CS :
					if (context == grammarAccess.getDictLiteralExpCSRule()
						...
						|| context == grammarAccess.getPrefixedExpCSRule()
						|| context == grammarAccess.getPrimaryExpCSRule()) {
						sequence_DictLiteralExpCS(context,
							(DictLiteralExpCS) semanticObject);
						return;
					} else
						break;
				case ImperativeoclcsPackage.DICT_LITERAL_PART_CS :
					if (context == grammarAccess.getDictLiteralPartCSRule()) {
						sequence_DictLiteralPartCS(context,
							(DictLiteralPartCS) semanticObject);
						return;
					} else
						break;
				case ImperativeoclcsPackage.DICT_TYPE_CS :
					if (context == grammarAccess.getDictTypeCSRule()
						|| context == grammarAccess.getTypeLiteralCSRule()) {
						sequence_DictTypeCS(context,
							(DictTypeCS) semanticObject);
						return;
					} else if (context == grammarAccess.getTypeExpCSRule()) {
						sequence_DictTypeCS_TypeExpCS(context,
							(DictTypeCS) semanticObject);
						return;
					} else if (context == grammarAccess
						.getTypeLiteralWithMultiplicityCSRule()) {
						sequence_DictTypeCS_TypeLiteralWithMultiplicityCS(
							context, (DictTypeCS) semanticObject);
						return;
					} else
						break;
				case ImperativeoclcsPackage.LIST_LITERAL_EXP_CS :
					if (context == grammarAccess.getExpCSRule()
						...
						|| context == grammarAccess.getPrefixedExpCSRule()
						|| context == grammarAccess.getPrimaryExpCSRule()) {
						sequence_ListLiteralExpCS(context,
							(ListLiteralExpCS) semanticObject);
						return;
					} else
						break;
				case ImperativeoclcsPackage.LIST_TYPE_CS :
					if (context == grammarAccess.getListTypeCSRule()
						|| context == grammarAccess.getTypeLiteralCSRule()) {
						sequence_ListTypeCS(context,
							(ListTypeCS) semanticObject);
						return;
					} else if (context == grammarAccess.getTypeExpCSRule()) {
						sequence_ListTypeCS_TypeExpCS(context,
							(ListTypeCS) semanticObject);
						return;
					} else if (context == grammarAccess
						.getTypeLiteralWithMultiplicityCSRule()) {
						sequence_ListTypeCS_TypeLiteralWithMultiplicityCS(
							context, (ListTypeCS) semanticObject);
						return;
					} else
						break;
				case ImperativeoclcsPackage.RETURN_EXP_CS :
					if (context == grammarAccess.getExpCSRule()
						...
						sequence_ReturnExpCS(context,
							(ReturnExpCS) semanticObject);
						return;
					} else
						break;
			}
		else if (semanticObject.eClass().getEPackage() == QvtoperationalcsPackage.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
				case QvtoperationalcsPackage.CLASSIFIER_CS :
					if (context == grammarAccess.getClassifierCSRule()
						...
						sequence_ClassifierCS(context,
							(ClassifierCS) semanticObject);
						return;
					} else
						break;
				case QvtoperationalcsPackage.CLASSIFIER_OPERATION_CS :
					if (context == grammarAccess.getClassifierFeatureCSRule()
						|| context == grammarAccess
							.getClassifierOperationCSRule()) {
						sequence_ClassifierOperationCS(context,
							(ClassifierOperationCS) semanticObject);
						return;
					} else
						break;
				case QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS :
					if (context == grammarAccess.getClassifierFeatureCSRule()
						|| context == grammarAccess
							.getClassifierPropertyCSRule()) {
						sequence_ClassifierPropertyCS(context,
							(ClassifierPropertyCS) semanticObject);
						return;
					} else
						break;
				case QvtoperationalcsPackage.ENUMERATION_CS :
					if (context == grammarAccess.getEnumerationCSRule()
						|| context == grammarAccess.getMetamodelElementCSRule()) {
						sequence_EnumerationCS(context,
				...
				case QvtoperationalcsPackage.INIT_PART_CS :
					if (context == grammarAccess.getInitPartCSRule()) {
						sequence_InitPartCS(context,
							(InitPartCS) semanticObject);
						return;
					} else
						break;
				case QvtoperationalcsPackage.METAMODEL_CS :
					if (context == grammarAccess.getMetamodelCSRule()
						...
						sequence_MetamodelCS(context,
							(MetamodelCS) semanticObject);
						return;
					} else
						break;
				case QvtoperationalcsPackage.MULTIPLICITY_CS :
					if (context == grammarAccess.getMultiplicityCSRule()) {
						sequence_MultiplicityCS(context,
							(MultiplicityCS) semanticObject);
						return;
					} else
						break;
				...
				case QvtoperationalcsPackage.SIMPLE_SIGNATURE_CS :
					if (context == grammarAccess.getCompleteSignatureCSRule()) {
						sequence_CompleteSignatureCS_SimpleSignatureCS(context,
							(SimpleSignatureCS) semanticObject);
						return;
					} else if (context == grammarAccess
						.getSimpleSignatureCSRule()) {
						sequence_SimpleSignatureCS(context,
							(SimpleSignatureCS) semanticObject);
						return;
					} else
						break;
	...
	/**
	 * Constraint: ( intermediate?='intermediate'? qualifier+=Qualifier*
	 * keyword=ClassifierKind pathName=PathNameCS (extends+=PathNameCS
	 * extends+=PathNameCS*)? (feature+=ClassifierFeatureCS
	 * feature+=ClassifierFeatureCS*)? )
	 */
	protected void sequence_ClassifierCS(EObject context,
			ClassifierCS semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}

	/**
	 * Constraint: ((stereotype+=Identifier stereotype+=Identifier*)?
	 * featureKey+=FeatureKey* name=Identifier typespec=TypeExpCS
	 * signature=CompleteSignatureCS)
	 */
	protected void sequence_ClassifierOperationCS(EObject context,
			ClassifierOperationCS semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 * Constraint: ( (stereotype+=Identifier stereotype+=Identifier*)?
	 * featureKey+=FeatureKey* name=Identifier typespec=TypeExpCS
	 * initPart=InitPartCS? multiplicity=MultiplicityCS? (tilde?='~'?
	 * oppositeIdentifier=Identifier oppositeMultiplicity=MultiplicityCS?)? )
	 */
	protected void sequence_ClassifierPropertyCS(EObject context,
			ClassifierPropertyCS semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}

	/**
	 * Constraint: ((param+=ParamCS param+=ParamCS*)? (param+=ParamCS
	 * param+=ParamCS*)?)
	 */
	protected void sequence_CompleteSignatureCS_SimpleSignatureCS(
			EObject context, SimpleSignatureCS semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}

	/**
	 * Constraint: (name=Identifier (literal+=Identifier literal+=Identifier*)?)
	 */
	protected void sequence_EnumerationCS(EObject context,
			EnumerationCS semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}

	/**
	 * Constraint: (unit=UnitCS | (unit=UnitCS ((name+=Identifier
	 * name+=Identifier*) | all?='*')))
	 */
	...
	/**
	 * Constraint: (initOp=InitOp expression=ExpCS)
	 */
	protected void sequence_InitPartCS(EObject context,
			InitPartCS semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject,
				QvtoperationalcsPackage.Literals.INIT_PART_CS__INIT_OP) == ValueTransient.YES)
				errorAcceptor
					.accept(diagnosticProvider.createFeatureValueMissing(
						semanticObject,
						QvtoperationalcsPackage.Literals.INIT_PART_CS__INIT_OP));
			if (transientValues.isValueTransient(semanticObject,
				QvtoperationalcsPackage.Literals.INIT_PART_CS__EXPRESSION) == ValueTransient.YES)
				errorAcceptor
					.accept(diagnosticProvider
						.createFeatureValueMissing(
							semanticObject,
							QvtoperationalcsPackage.Literals.INIT_PART_CS__EXPRESSION));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getInitPartCSAccess()
			.getInitOpInitOpEnumRuleCall_0_0(), semanticObject.getInitOp());
		feeder.accept(grammarAccess.getInitPartCSAccess()
			.getExpressionExpCSParserRuleCall_1_0(), semanticObject
			.getExpression());
		feeder.finish();
	}

	/**
	 * Constraint: (keyword=MetamodelKind pathName=PathNameCS
	 * element+=MetamodelElementCS*)
	 */
	protected void sequence_MetamodelCS(EObject context,
			MetamodelCS semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_MultiplicityCS(EObject context,
			MultiplicityCS semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}

	/**
	 * Constraint: (direction=ParamDirection? pathName=PathNameCS
	 * typespec=TypeExpCS initPart=InitPartCS?)
	 */
	...
	/**
	 * Constraint: ((param+=ParamCS param+=ParamCS*)?)
	 */
	protected void sequence_SimpleSignatureCS(EObject context,
			SimpleSignatureCS semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}

	/**
	 * Constraint: (id=StringLiteral pathName=PathNameCS expression=ExpCS?)
	 */
	...
	/**
	 * Constraint: (import+=ImportCS* unit+=UnitElementCS*)
	 */
	protected void sequence_TopLevelCS(EObject context,
			TopLevelCS semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}

	/**
	 * Constraint: (name=Identifier typespec=TypeExpCS condition=ExpCS?)
	 */
	...
	/**
	 * Constraint: (segment+=Identifier segment+=Identifier*)
	 */
