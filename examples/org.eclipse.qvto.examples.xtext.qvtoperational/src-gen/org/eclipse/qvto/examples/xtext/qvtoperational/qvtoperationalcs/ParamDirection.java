...
public enum ParamDirection
	...
	/**
	 * A public read-only list of all the '<em><b>Param Direction</b></em>'
	 * enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public static final List<ParamDirection> VALUES = Collections
		.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Param Direction</b></em>' literal with the specified
