 ...
 * <ul>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ParamCSImpl#getDirection
 * <em>Direction</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ParamCSImpl#getPathName
 * <em>Path Name</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ParamCSImpl#getTypespec
 * <em>Typespec</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ParamCSImpl#getInitPart
 * <em>Init Part</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ParamCSImpl
	...
	public void setDirection(ParamDirection newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.PARAM_CS__DIRECTION, oldDirection,
				direction));
	}
	...
	public NotificationChain basicSetPathName(PathNameCS newPathName,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
				Notification.SET, QvtoperationalcsPackage.PARAM_CS__PATH_NAME,
	...
	public void setPathName(PathNameCS newPathName) {
		if (newPathName != pathName) {
			...
			if (pathName != null)
				msgs = ((InternalEObject) pathName).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE
						- QvtoperationalcsPackage.PARAM_CS__PATH_NAME, null,
					msgs);
			if (newPathName != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.PARAM_CS__PATH_NAME, newPathName,
				newPathName));
	}
	...
	public NotificationChain basicSetTypespec(TypedRefCS newTypespec,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
				Notification.SET, QvtoperationalcsPackage.PARAM_CS__TYPESPEC,
		...
		if (newTypespec != typespec) {
			...
			if (typespec != null)
				msgs = ((InternalEObject) typespec).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE
						- QvtoperationalcsPackage.PARAM_CS__TYPESPEC, null,
					msgs);
			if (newTypespec != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.PARAM_CS__TYPESPEC, newTypespec,
				newTypespec));
	}
	...
	public NotificationChain basicSetInitPart(InitPartCS newInitPart,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
				Notification.SET, QvtoperationalcsPackage.PARAM_CS__INIT_PART,
	...
	public void setInitPart(InitPartCS newInitPart) {
		if (newInitPart != initPart) {
			NotificationChain msgs = null;
			if (initPart != null)
				msgs = ((InternalEObject) initPart).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE
						- QvtoperationalcsPackage.PARAM_CS__INIT_PART, null,
					msgs);
			if (newInitPart != null)
				msgs = ((InternalEObject) newInitPart).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE
						- QvtoperationalcsPackage.PARAM_CS__INIT_PART, null,
					msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.PARAM_CS__INIT_PART, newInitPart,
				newInitPart));
	}
