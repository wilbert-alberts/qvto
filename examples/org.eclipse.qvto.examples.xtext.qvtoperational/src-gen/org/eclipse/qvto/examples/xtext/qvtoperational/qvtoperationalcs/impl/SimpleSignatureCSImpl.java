 ...
 * <ul>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.SimpleSignatureCSImpl#getParam
 * <em>Param</em>}</li>
 * </ul>
 * </p>
 * 
...
public class SimpleSignatureCSImpl
		extends CompleteSignatureCSImpl
	...
	public EList<ParamCS> getParam() {
		if (param == null) {
			param = new EObjectContainmentEList<ParamCS>(ParamCS.class, this,
				QvtoperationalcsPackage.SIMPLE_SIGNATURE_CS__PARAM);
		}
		return param;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
			case QvtoperationalcsPackage.SIMPLE_SIGNATURE_CS__PARAM :
				return ((InternalEList<?>) getParam()).basicRemove(otherEnd,
					msgs);
		}
