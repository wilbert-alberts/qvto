 ...
 * <ul>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ClassifierPropertyCSImpl#getStereotype
 * <em>Stereotype</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ClassifierPropertyCSImpl#getFeatureKey
 * <em>Feature Key</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ClassifierPropertyCSImpl#getName
 * <em>Name</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ClassifierPropertyCSImpl#getTypespec
 * <em>Typespec</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ClassifierPropertyCSImpl#getInitPart
 * <em>Init Part</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ClassifierPropertyCSImpl#getMultiplicity
 * <em>Multiplicity</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ClassifierPropertyCSImpl#isTilde
 * <em>Tilde</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ClassifierPropertyCSImpl#getOppositeIdentifier
 * <em>Opposite Identifier</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ClassifierPropertyCSImpl#getOppositeMultiplicity
 * <em>Opposite Multiplicity</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class ClassifierPropertyCSImpl
	...
	/**
	 * The cached value of the '{@link #getInitPart() <em>Init Part</em>}'
	 * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getInitPart()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getOppositeIdentifier()
	 * <em>Opposite Identifier</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getOppositeIdentifier()
	 * <em>Opposite Identifier</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getOppositeIdentifier()
	...
	/**
	 * The cached value of the '{@link #getOppositeMultiplicity()
	 * <em>Opposite Multiplicity</em>}' containment reference. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public EList<String> getStereotype() {
		if (stereotype == null) {
			stereotype = new EDataTypeEList<String>(String.class, this,
				QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<FeatureKey> getFeatureKey() {
		if (featureKey == null) {
			featureKey = new EDataTypeEList<FeatureKey>(FeatureKey.class, this,
				QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__FEATURE_KEY);
		}
		return featureKey;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__NAME, oldName,
				name));
	}
	...
	public NotificationChain basicSetTypespec(TypedRefCS newTypespec,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
				Notification.SET,
				QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__TYPESPEC,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInitPart(InitPartCS newInitPart,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
				Notification.SET,
				QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__INIT_PART,
				oldInitPart, newInitPart);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
			...
			if (initPart != null)
				msgs = ((InternalEObject) initPart)
					.eInverseRemove(
						...
						null, msgs);
			if (newInitPart != null)
				msgs = ((InternalEObject) newInitPart)
					.eInverseAdd(
						this,
						EOPPOSITE_FEATURE_BASE
							- QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__INIT_PART,
	...
	public NotificationChain basicSetMultiplicity(
			MultiplicityCS newMultiplicity, NotificationChain msgs) {
		MultiplicityCS oldMultiplicity = multiplicity;
		multiplicity = newMultiplicity;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
				Notification.SET,
				QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__MULTIPLICITY,
				oldMultiplicity, newMultiplicity);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setMultiplicity(MultiplicityCS newMultiplicity) {
		if (newMultiplicity != multiplicity) {
			...
			if (multiplicity != null)
				msgs = ((InternalEObject) multiplicity)
					.eInverseRemove(
						this,
						EOPPOSITE_FEATURE_BASE
							- QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__MULTIPLICITY,
			...
			if (newMultiplicity != null)
				msgs = ((InternalEObject) newMultiplicity)
					.eInverseAdd(
						this,
						EOPPOSITE_FEATURE_BASE
							- QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__MULTIPLICITY,
	...
	public void setTilde(boolean newTilde) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__TILDE,
				oldTilde, tilde));
	}
	...
	public void setOppositeIdentifier(String newOppositeIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
				this,
				Notification.SET,
				QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__OPPOSITE_IDENTIFIER,
				oldOppositeIdentifier, oppositeIdentifier));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOppositeMultiplicity(
			MultiplicityCS newOppositeMultiplicity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
				this,
				Notification.SET,
				QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__OPPOSITE_MULTIPLICITY,
				oldOppositeMultiplicity, newOppositeMultiplicity);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setOppositeMultiplicity(MultiplicityCS newOppositeMultiplicity) {
		if (newOppositeMultiplicity != oppositeMultiplicity) {
			...
			if (oppositeMultiplicity != null)
				msgs = ((InternalEObject) oppositeMultiplicity)
					.eInverseRemove(
						this,
						EOPPOSITE_FEATURE_BASE
							- QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__OPPOSITE_MULTIPLICITY,
			...
			if (newOppositeMultiplicity != null)
				msgs = ((InternalEObject) newOppositeMultiplicity)
					.eInverseAdd(
						this,
						EOPPOSITE_FEATURE_BASE
							- QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__OPPOSITE_MULTIPLICITY,
			...
			eNotify(new ENotificationImpl(
				...
				Notification.SET,
				QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__OPPOSITE_MULTIPLICITY,
				newOppositeMultiplicity, newOppositeMultiplicity));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__OPPOSITE_IDENTIFIER :
				return OPPOSITE_IDENTIFIER_EDEFAULT == null
					? oppositeIdentifier != null
					: !OPPOSITE_IDENTIFIER_EDEFAULT.equals(oppositeIdentifier);
			case QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS__OPPOSITE_MULTIPLICITY :
