...
public interface QvtoperationalcsFactory extends EFactory
{
   ...
   * @generated
   */
  QvtoperationalcsFactory eINSTANCE = org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.QvtoperationalcsFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Param CS</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns a new object of class '<em>Typedef CS</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
