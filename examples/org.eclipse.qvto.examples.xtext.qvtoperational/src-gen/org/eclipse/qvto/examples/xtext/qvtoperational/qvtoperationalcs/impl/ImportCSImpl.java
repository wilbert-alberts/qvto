 ...
 * <ul>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ImportCSImpl#getUnit
 * <em>Unit</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ImportCSImpl#getName
 * <em>Name</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ImportCSImpl#isAll
 * <em>All</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ImportCSImpl
	...
	public NotificationChain basicSetUnit(UnitCS newUnit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
				Notification.SET, QvtoperationalcsPackage.IMPORT_CS__UNIT,
				oldUnit, newUnit);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setUnit(UnitCS newUnit) {
		if (newUnit != unit) {
			...
			if (unit != null)
				msgs = ((InternalEObject) unit).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE
						- QvtoperationalcsPackage.IMPORT_CS__UNIT, null, msgs);
			if (newUnit != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.IMPORT_CS__UNIT, newUnit, newUnit));
	}
	...
	public EList<String> getName() {
		if (name == null) {
			name = new EDataTypeEList<String>(String.class, this,
				QvtoperationalcsPackage.IMPORT_CS__NAME);
		}
		return name;
	}
	...
	public void setAll(boolean newAll) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.IMPORT_CS__ALL, oldAll, all));
	}
