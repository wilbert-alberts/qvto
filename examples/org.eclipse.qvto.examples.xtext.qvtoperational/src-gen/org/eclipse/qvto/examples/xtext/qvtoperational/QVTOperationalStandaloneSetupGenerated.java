...
public class QVTOperationalStandaloneSetupGenerated
		implements ISetup {

	public Injector createInjectorAndDoEMFRegistration() {
		org.eclipse.qvto.examples.xtext.imperativeocl.ImperativeOCLStandaloneSetup
			.doSetup();
	...
	public Injector createInjector() {
		return Guice
			.createInjector(new org.eclipse.qvto.examples.xtext.qvtoperational.QVTOperationalRuntimeModule());
	}

	public void register(Injector injector) {
		if (!EPackage.Registry.INSTANCE
			.containsKey("http://www.eclipse.org/qvt/pivot/1.0/QVTOperationalCS")) {
			EPackage.Registry.INSTANCE
				.put(
					"http://www.eclipse.org/qvt/pivot/1.0/QVTOperationalCS",
					org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.QvtoperationalcsPackage.eINSTANCE);
		}
		...
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put(
			"qvto", resourceFactory);
		org.eclipse.xtext.resource.IResourceServiceProvider.Registry.INSTANCE
			.getExtensionToFactoryMap().put("qvto", serviceProvider);
