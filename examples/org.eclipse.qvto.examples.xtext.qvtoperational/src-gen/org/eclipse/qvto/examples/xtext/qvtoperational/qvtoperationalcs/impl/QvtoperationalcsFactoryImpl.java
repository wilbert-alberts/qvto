...
public class QvtoperationalcsFactoryImpl extends EFactoryImpl implements QvtoperationalcsFactory
{
  ...
  public EObject create(EClass eClass)
  {
		switch (eClass.getClassifierID()) {
			...
			case QvtoperationalcsPackage.UNIT_ELEMENT_CS: return createUnitElementCS();
			...
			case QvtoperationalcsPackage.PARAM_CS: return createParamCS();
			...
			case QvtoperationalcsPackage.METAMODEL_ELEMENT_CS: return createMetamodelElementCS();
			case QvtoperationalcsPackage.CLASSIFIER_CS: return createClassifierCS();
			case QvtoperationalcsPackage.CLASSIFIER_FEATURE_CS: return createClassifierFeatureCS();
			case QvtoperationalcsPackage.CLASSIFIER_PROPERTY_CS: return createClassifierPropertyCS();
			case QvtoperationalcsPackage.MULTIPLICITY_CS: return createMultiplicityCS();
			case QvtoperationalcsPackage.CLASSIFIER_OPERATION_CS: return createClassifierOperationCS();
			case QvtoperationalcsPackage.ENUMERATION_CS: return createEnumerationCS();
			case QvtoperationalcsPackage.TAG_CS: return createTagCS();
			case QvtoperationalcsPackage.TYPEDEF_CS: return createTypedefCS();
			default:
