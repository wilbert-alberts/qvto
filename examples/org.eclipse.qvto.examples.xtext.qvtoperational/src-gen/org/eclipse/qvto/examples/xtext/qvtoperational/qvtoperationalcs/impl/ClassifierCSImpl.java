 ...
 * <ul>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ClassifierCSImpl#isIntermediate
 * <em>Intermediate</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ClassifierCSImpl#getQualifier
 * <em>Qualifier</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ClassifierCSImpl#getKeyword
 * <em>Keyword</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ClassifierCSImpl#getPathName
 * <em>Path Name</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ClassifierCSImpl#getExtends
 * <em>Extends</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.ClassifierCSImpl#getFeature
 * <em>Feature</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class ClassifierCSImpl
		extends MetamodelElementCSImpl
		implements ClassifierCS {

	/**
	 * The default value of the '{@link #isIntermediate() <em>Intermediate</em>}
	...
	/**
	 * The cached value of the '{@link #isIntermediate() <em>Intermediate</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isIntermediate()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getPathName() <em>Path Name</em>}'
	...
	public void setIntermediate(boolean newIntermediate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.CLASSIFIER_CS__INTERMEDIATE,
	...
	public EList<Qualifier> getQualifier() {
		if (qualifier == null) {
			qualifier = new EDataTypeEList<Qualifier>(Qualifier.class, this,
				QvtoperationalcsPackage.CLASSIFIER_CS__QUALIFIER);
		}
		return qualifier;
	}
	...
	public void setKeyword(ClassifierKind newKeyword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.CLASSIFIER_CS__KEYWORD, oldKeyword,
				keyword));
	}
	...
	public NotificationChain basicSetPathName(PathNameCS newPathName,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
				Notification.SET,
				QvtoperationalcsPackage.CLASSIFIER_CS__PATH_NAME, oldPathName,
				newPathName);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setPathName(PathNameCS newPathName) {
		if (newPathName != pathName) {
			...
			if (pathName != null)
				msgs = ((InternalEObject) pathName).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE
						- QvtoperationalcsPackage.CLASSIFIER_CS__PATH_NAME,
					null, msgs);
			if (newPathName != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.CLASSIFIER_CS__PATH_NAME, newPathName,
				newPathName));
	}
	...
	public EList<PathNameCS> getExtends() {
		if (extends_ == null) {
			extends_ = new EObjectContainmentEList<PathNameCS>(
				PathNameCS.class, this,
				QvtoperationalcsPackage.CLASSIFIER_CS__EXTENDS);
		}
		return extends_;
	}
	...
	public EList<ClassifierFeatureCS> getFeature() {
		if (feature == null) {
			feature = new EObjectContainmentEList<ClassifierFeatureCS>(
				ClassifierFeatureCS.class, this,
				QvtoperationalcsPackage.CLASSIFIER_CS__FEATURE);
		}
		return feature;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
			...
			case QvtoperationalcsPackage.CLASSIFIER_CS__FEATURE :
				return ((InternalEList<?>) getFeature()).basicRemove(otherEnd,
					msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case QvtoperationalcsPackage.CLASSIFIER_CS__QUALIFIER :
				getQualifier().clear();
				getQualifier().addAll(
					(Collection<? extends Qualifier>) newValue);
				return;
			case QvtoperationalcsPackage.CLASSIFIER_CS__KEYWORD :
			...
			case QvtoperationalcsPackage.CLASSIFIER_CS__EXTENDS :
				getExtends().clear();
				getExtends()
					.addAll((Collection<? extends PathNameCS>) newValue);
				return;
			case QvtoperationalcsPackage.CLASSIFIER_CS__FEATURE :
				getFeature().clear();
				getFeature().addAll(
					(Collection<? extends ClassifierFeatureCS>) newValue);
				return;
		}
