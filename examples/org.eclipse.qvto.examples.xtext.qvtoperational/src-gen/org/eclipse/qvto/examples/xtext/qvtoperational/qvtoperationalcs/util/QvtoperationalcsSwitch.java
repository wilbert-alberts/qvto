...
public class QvtoperationalcsSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
		switch (classifierID) {
			...
			case QvtoperationalcsPackage.QVT_OPERATIONAL_CS_VISITOR: {
				QVTOperationalCSVisitor<?> qvtOperationalCSVisitor = (QVTOperationalCSVisitor<?>)theEObject;
				T result = caseQVTOperationalCSVisitor(qvtOperationalCSVisitor);
				if (result == null) result = caseImperativeOCLCSVisitor(qvtOperationalCSVisitor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
  ...
  /**
	 * Returns the result of interpreting the object as an instance of '<em>QVT Operational CS Visitor</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>QVT Operational CS Visitor</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public <R> T caseQVTOperationalCSVisitor(QVTOperationalCSVisitor<R> object) {
		return null;
	}
