...
public abstract class AbstractQVTOperationalCSVisitor<R, C>
		extends
		org.eclipse.qvto.examples.xtext.imperativeocl.imperativeoclcs.util.AbstractImperativeOCLCSVisitor<R, C>
	 ...
	 */
	protected AbstractQVTOperationalCSVisitor(@NonNull
	C context) {
		super(context);
	}
}
