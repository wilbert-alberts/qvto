 ...
 * <ul>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.TagCSImpl#getId
 * <em>Id</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.TagCSImpl#getPathName
 * <em>Path Name</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.TagCSImpl#getExpression
 * <em>Expression</em>}</li>
 * </ul>
 * </p>
 * 
...
public class TagCSImpl
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.TAG_CS__ID, oldId, id));
	}
	...
	public NotificationChain basicSetPathName(PathNameCS newPathName,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
				Notification.SET, QvtoperationalcsPackage.TAG_CS__PATH_NAME,
	...
	public void setPathName(PathNameCS newPathName) {
		if (newPathName != pathName) {
			...
			if (pathName != null)
				msgs = ((InternalEObject) pathName)
					.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- QvtoperationalcsPackage.TAG_CS__PATH_NAME, null, msgs);
			if (newPathName != null)
				msgs = ((InternalEObject) newPathName)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.TAG_CS__PATH_NAME, newPathName,
				newPathName));
	}
	...
	public NotificationChain basicSetExpression(ExpCS newExpression,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
				Notification.SET, QvtoperationalcsPackage.TAG_CS__EXPRESSION,
	...
	public void setExpression(ExpCS newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject) expression).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE
						- QvtoperationalcsPackage.TAG_CS__EXPRESSION, null,
					msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.TAG_CS__EXPRESSION, newExpression,
				newExpression));
	}
