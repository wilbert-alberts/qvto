 ...
 * <ul>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.MetamodelCSImpl#getKeyword
 * <em>Keyword</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.MetamodelCSImpl#getPathName
 * <em>Path Name</em>}</li>
 * <li>
 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.MetamodelCSImpl#getElement
 * <em>Element</em>}</li>
 * </ul>
 * </p>
 * 
...
public class MetamodelCSImpl
	...
	public void setKeyword(MetamodelKind newKeyword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.METAMODEL_CS__KEYWORD, oldKeyword,
				keyword));
	}
	...
	public NotificationChain basicSetPathName(PathNameCS newPathName,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
				Notification.SET,
				QvtoperationalcsPackage.METAMODEL_CS__PATH_NAME, oldPathName,
				newPathName);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setPathName(PathNameCS newPathName) {
		if (newPathName != pathName) {
			...
			if (pathName != null)
				msgs = ((InternalEObject) pathName).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE
						- QvtoperationalcsPackage.METAMODEL_CS__PATH_NAME,
					null, msgs);
			if (newPathName != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				QvtoperationalcsPackage.METAMODEL_CS__PATH_NAME, newPathName,
				newPathName));
	}
	...
	public EList<MetamodelElementCS> getElement() {
		if (element == null) {
			element = new EObjectContainmentEList<MetamodelElementCS>(
				MetamodelElementCS.class, this,
				QvtoperationalcsPackage.METAMODEL_CS__ELEMENT);
		}
		return element;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
			...
			case QvtoperationalcsPackage.METAMODEL_CS__ELEMENT :
				return ((InternalEList<?>) getElement()).basicRemove(otherEnd,
					msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case QvtoperationalcsPackage.METAMODEL_CS__ELEMENT :
				getElement().clear();
				getElement().addAll(
					(Collection<? extends MetamodelElementCS>) newValue);
				return;
		}
