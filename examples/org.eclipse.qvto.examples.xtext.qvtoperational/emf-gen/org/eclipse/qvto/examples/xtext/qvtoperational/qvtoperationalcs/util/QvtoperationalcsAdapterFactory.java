...
public class QvtoperationalcsAdapterFactory
	...
	protected QvtoperationalcsSwitch<Adapter> modelSwitch = new QvtoperationalcsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseQVToParameterCS(QVToParameterCS object) {
				return createQVToParameterCSAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.QVToParameterCS <em>QV To Parameter CS</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createQVToParameterCSAdapter() {
		return null;
	}
	 ...
	 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.RenameCS
	 * <em>Rename CS</em>}'. <!-- begin-user-doc --> This default implementation
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.ClassCS
	 * <em>Class CS</em>}'. <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a
	 * case when inheritance will catch all the cases anyway. <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.DirectionKindCS <em>Direction Kind CS</em>}'.
	 * <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.ocl.examples.domain.elements.Nameable
	 ...
	 * <em>Type CS</em>}'. <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a
	 * case when inheritance will catch all the cases anyway. <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.ocl.examples.xtext.essentialocl.essentialOCLCST.ExpCS
	 * <em>Exp CS</em>}'. <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a
	 * case when inheritance will catch all the cases anyway. <!-- end-user-doc
	 * -->
	 * 
