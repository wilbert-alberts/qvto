 ...
 * <em><b>Module Kind Enum</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.QvtoperationalcsPackage#getModuleKindEnum()
 * @model
 * @generated
 */
public enum ModuleKindEnum
	 ...
	 * -->
	 * <p>
	 * If the meaning of '<em><b>Transformation</b></em>' literal object isn't
	 ...
	 * @generated
	 */
	private static final ModuleKindEnum[] VALUES_ARRAY = new ModuleKindEnum[] {
			TRANSFORMATION,
			LIBRARY,
		};
