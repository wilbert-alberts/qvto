 ...
 * <ul>
 *   <li>{@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.MappingSectionsCSImpl#getMappingInitCS <em>Mapping Init CS</em>}</li>
 *   <li>{@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.MappingSectionsCSImpl#getMappingBodyCS <em>Mapping Body CS</em>}</li>
 *   <li>{@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.MappingSectionsCSImpl#getMappingEndCS <em>Mapping End CS</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MappingSectionsCSImpl
		extends ElementCSImpl
		implements MappingSectionsCS {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMappingInitCS(
			MappingInitCS newMappingInitCS, NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMappingBodyCS(
			MappingBodyCS newMappingBodyCS, NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMappingEndCS(MappingEndCS newMappingEndCS,
	...
	public <R> R accept(final org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.util.QVTOperationalCSVisitor<R> v) {
		return v.visitMappingSectionsCS(this);
	}
	...
	public <R> R accept(final BaseCSVisitor<R> v) {
		return ((QVTOperationalCSVisitor<R>)v).visitMappingSectionsCS(this);
	}
