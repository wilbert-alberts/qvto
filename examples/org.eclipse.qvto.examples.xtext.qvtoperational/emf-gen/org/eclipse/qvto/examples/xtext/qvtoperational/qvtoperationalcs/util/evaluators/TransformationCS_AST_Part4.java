...
public class TransformationCS_AST_Part4
{
    public static final/*@NonNull*/ TransformationCS_AST_Part4 INSTANCE = new TransformationCS_AST_Part4();
    ...
    public /*@Nullable*/ /*@NonInvalid*/ List<ClassifierCS> evaluate(final /*@NonNull*/ /*@NonInvalid*/ DomainEvaluator evaluator, final /*@NonNull*/ /*@NonInvalid*/ TypeId typeId, final /*@NonNull*/ /*@NonInvalid*/ TransformationCS self) {
