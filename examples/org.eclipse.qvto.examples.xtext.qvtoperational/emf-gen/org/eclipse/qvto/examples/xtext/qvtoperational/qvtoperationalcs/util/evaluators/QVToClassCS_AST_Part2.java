...
public class QVToClassCS_AST_Part2
{
    public static final/*@NonNull*/ QVToClassCS_AST_Part2 INSTANCE = new QVToClassCS_AST_Part2();
    ...
    public /*@Nullable*/ /*@NonInvalid*/ List<OperationCS> evaluate(final /*@NonNull*/ /*@NonInvalid*/ DomainEvaluator evaluator, final /*@NonNull*/ /*@NonInvalid*/ TypeId typeId, final /*@NonNull*/ /*@NonInvalid*/ QVToClassCS self) {
