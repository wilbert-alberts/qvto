...
public class MappingOperationCS_AST_Part0
{
    public static final/*@NonNull*/ MappingOperationCS_AST_Part0 INSTANCE = new MappingOperationCS_AST_Part0();
    ...
    public /*@Nullable*/ /*@NonInvalid*/ String evaluate(final /*@NonNull*/ /*@NonInvalid*/ DomainEvaluator evaluator, final /*@NonNull*/ /*@NonInvalid*/ TypeId typeId, final /*@NonNull*/ /*@NonInvalid*/ MappingOperationCS self) {
