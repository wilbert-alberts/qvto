...
public class TopLevelCS_AST_Part0
{
    public static final/*@NonNull*/ TopLevelCS_AST_Part0 INSTANCE = new TopLevelCS_AST_Part0();
    ...
    public /*@Nullable*/ /*@NonInvalid*/ List<PackageCS> evaluate(final /*@NonNull*/ /*@NonInvalid*/ DomainEvaluator evaluator, final /*@NonNull*/ /*@NonInvalid*/ TypeId typeId, final /*@NonNull*/ /*@NonInvalid*/ TopLevelCS self) {
