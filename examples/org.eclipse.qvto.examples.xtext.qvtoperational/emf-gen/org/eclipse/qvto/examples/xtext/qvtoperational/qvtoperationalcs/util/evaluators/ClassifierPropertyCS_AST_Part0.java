...
public class ClassifierPropertyCS_AST_Part0
{
    public static final/*@NonNull*/ ClassifierPropertyCS_AST_Part0 INSTANCE = new ClassifierPropertyCS_AST_Part0();
    ...
    public /*@Nullable*/ /*@NonInvalid*/ String evaluate(final /*@NonNull*/ /*@NonInvalid*/ DomainEvaluator evaluator, final /*@NonNull*/ /*@NonInvalid*/ TypeId typeId, final /*@NonNull*/ /*@NonInvalid*/ ClassifierPropertyCS self) {
