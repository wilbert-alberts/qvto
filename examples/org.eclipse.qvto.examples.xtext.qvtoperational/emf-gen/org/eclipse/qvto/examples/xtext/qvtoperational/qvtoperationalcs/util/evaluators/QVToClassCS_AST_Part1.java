...
public class QVToClassCS_AST_Part1
{
    public static final/*@NonNull*/ QVToClassCS_AST_Part1 INSTANCE = new QVToClassCS_AST_Part1();
    ...
    public /*@Nullable*/ /*@NonInvalid*/ List<StructuralFeatureCS> evaluate(final /*@NonNull*/ /*@NonInvalid*/ DomainEvaluator evaluator, final /*@NonNull*/ /*@NonInvalid*/ TypeId typeId, final /*@NonNull*/ /*@NonInvalid*/ QVToClassCS self) {
