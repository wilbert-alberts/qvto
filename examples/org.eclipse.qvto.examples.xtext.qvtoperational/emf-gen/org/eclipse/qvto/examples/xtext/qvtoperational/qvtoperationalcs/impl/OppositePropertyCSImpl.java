 ...
 * <ul>
 *   <li>{@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.OppositePropertyCSImpl#isIsNavigable <em>Is Navigable</em>}</li>
 *   <li>{@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.OppositePropertyCSImpl#getSimpleNameCS <em>Simple Name CS</em>}</li>
 *   <li>{@link org.eclipse.qvto.examples.xtext.qvtoperational.qvtoperationalcs.impl.OppositePropertyCSImpl#getMultiplicity <em>Multiplicity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OppositePropertyCSImpl
		extends ElementCSImpl
		implements OppositePropertyCS {
	...
	public <R> R accept(final QVTOperationalCSVisitor<R> v) {
		return v.visitOppositePropertyCS(this);
	}
	...
	public <R> R accept(final BaseCSVisitor<R> v) {
		return ((QVTOperationalCSVisitor<R>)v).visitOppositePropertyCS(this);
	}
