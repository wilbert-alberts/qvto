 ...
 * </copyright>
 *
 * $Id: ConstraintsPackageImpl.java,v 1.1 2007/07/29 21:25:33 radvorak Exp $
 */
...
public class ConstraintsPackageImpl extends EPackageImpl implements ConstraintsPackage {
    ...
    public static ConstraintsPackage init() {
		...
		ViewPackageImpl theViewPackage = (ViewPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(ViewPackage.eNS_URI) instanceof ViewPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(ViewPackage.eNS_URI) : ViewPackageImpl.eINSTANCE);
    ...
    public void initializePackageContents() {
		...
		initEReference(getColumnRefConstraint_IncludedColumns(), theRdbPackage.getTableColumn(), null, "includedColumns", null, 1, -1, ColumnRefConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIndexedColumn_RefColumn(), theRdbPackage.getTableColumn(), null, "refColumn", null, 1, 1, IndexedColumn.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
