 ...
 * </copyright>
 *
 * $Id: RdbPackageImpl.java,v 1.1 2007/07/29 21:25:34 radvorak Exp $
 */
package rdb.impl;
...
public class RdbPackageImpl extends EPackageImpl implements RdbPackage {
    ...
    public void initializePackageContents() {
		...
		ConstraintsPackageImpl theConstraintsPackage = (ConstraintsPackageImpl)EPackage.Registry.INSTANCE.getEPackage(ConstraintsPackage.eNS_URI);
		DatatypesPackageImpl theDatatypesPackage = (DatatypesPackageImpl)EPackage.Registry.INSTANCE.getEPackage(DatatypesPackage.eNS_URI);
		ViewPackageImpl theViewPackage = (ViewPackageImpl)EPackage.Registry.INSTANCE.getEPackage(ViewPackage.eNS_URI);
