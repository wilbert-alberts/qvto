...
public class TransformTests {
    ...
    public static ModelTestData[] createTestData() {
        return new ModelTestData[] {        		        		
        		new FileToFileData("importedContextlessOperation_273995"), //$NON-NLS-1$
    ...
    private static final Set<String> JAVALESS_EXCLUDES = new HashSet<String>(Arrays.asList(new String[] {
            ...
            "importedInstances", "fqnOperationCalls_271789", "fqnMainCalls_271987", "fqnMainCalls_272937", "importedContextlessOperation_273995", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
